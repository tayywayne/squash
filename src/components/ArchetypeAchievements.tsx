    ...
    return (
      <div className={`bg-white p-6 border-3 border-black shadow-brutal ${className}`}>
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-black text-dark">ARCHETYPE COLLECTION</h3>
        </div>
        ...
        {achievements.map((achievement, index) => {
          ...
          return (
            <div
              ...
              className="group relative bg-warning p-4 border-3 border-black hover:shadow-brutal transition-all duration-200 cursor-pointer"
            >
              {/* Achievement Badge */}
              <div className="text-center">
                <div className="text-2xl mb-2">{achievement.emoji}</div>
                <div className="text-xs font-black text-dark leading-tight">
                  {archetypeInfo?.title || achievement.archetype_name}
                </div>
              </div>

              {/* Unlock Date */}
              <div className="flex items-center justify-center mt-2 text-xs text-dark">
