        ...
        {achievements.map((achievement, index) => {
          ...
          return (
            <div
              ...
              className="group relative bg-lime-chartreuse border-3 border-black cursor-pointer w-14 h-14"
            >
              {/* Achievement Badge */}
              <div className="text-center p-1 flex flex-col items-center justify-between h-full overflow-hidden">
                ...
                <div className="text-[8px] font-black text-dark-teal leading-tight mt-0.5 line-clamp-1">
                  {archetypeInfo?.title || achievement.archetype_name}
                </div>

                {/* Unlock Date */}
                <div className="flex items-center justify-center mt-auto text-[7px] text-dark-teal">
