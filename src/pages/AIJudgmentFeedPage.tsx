  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        {/* Stats */}
        <div className="bg-gradient-to-r from-red-50 to-purple-50 p-6 rounded-lg border border-red-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div>
              <div className="text-2xl font-bold text-red-600">{rulings.length}</div>
      ...
      {rulings.length === 0 ? (
        ...
        <div className="space-y-4">
          {rulings.map((ruling) => (
            <div key={ruling.conflict_id} className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              {/* Ruling Header */}
              <div className="p-6">
              ...
              {expandedRuling === ruling.conflict_id && (
                <div className="border-t border-gray-200 p-6 bg-gray-50">
                  {/* Full AI Ruling */}
                  <div className="bg-gradient-to-r from-purple-900 via-red-900 to-purple-900 p-6 rounded-lg border-2 border-yellow-400 text-white mb-6">
                    <div className="text-center mb-4">
                      <h4 className="text-xl font-bold text-yellow-300">⚖️ JUDGE AI'S FINAL RULING ⚖️</h4>
                    </div>
