/*
  # Fix get_available_quests function

  1. Function Updates
    - Create or replace the `get_available_quests` function
    - Properly qualify all column references to avoid ambiguity
    - Return quests that are active and include user progress information

  2. Security
    - Function is accessible to authenticated users
    - Returns only active quests with user-specific progress data
*/
