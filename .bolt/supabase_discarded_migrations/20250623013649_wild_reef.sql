/*
  # Update leaderboard function to include archetype emoji

  1. Function Update
    - Modify `get_user_conflict_stats` to include `archetype_emoji` in the returned data
    - This allows the leaderboard to display user archetypes

  2. Returns
    - All existing fields plus `archetype_emoji`
*/

-- Update function to include archetype emoji
