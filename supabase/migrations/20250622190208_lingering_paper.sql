/*
  # Create user conflict stats function for leaderboard

  1. Function
    - `get_user_conflict_stats(start_date)` - Calculates user statistics for leaderboard
    - Accepts optional start_date parameter for weekly filtering
    - Returns user profile data with conflict statistics
    - Joins profiles and conflicts tables to aggregate data
  ...
  3. Security
    ...
    - Only returns data for users who have participated in conflicts
*/

-- Create function to get user conflict statistics
