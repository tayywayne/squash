/*
  ...
  3. Initial Data
    - Insert 5 initial quests with steps
    - Each quest has 3-5 steps of different types
*/
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'quests' AND policyname = 'Anyone can read active quests'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'quest_steps' AND policyname = 'Anyone can read quest steps'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'user_quests' AND policyname = 'Users can read their own quest progress'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'user_quests' AND policyname = 'Users can insert their own quest progress'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'user_quests' AND policyname = 'Users can update their own quest progress'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'user_quest_steps' AND policyname = 'Users can read their own quest step progress'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'user_quest_steps' AND policyname = 'Users can insert their own quest step progress'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'user_quest_steps' AND policyname = 'Users can update their own quest step progress'
  ) THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM quests WHERE id = '11111111-1111-1111-1111-111111111111') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM quest_steps WHERE quest_id = '11111111-1111-1111-1111-111111111111' AND step_number = 1) THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM quest_steps WHERE quest_id = '22222222-2222-2222-2222-222222222222' AND step_number = 1) THEN
    INSERT INTO quest_steps (quest_id, step_number, title, instruction, step_type, options, correct_answer, feedback_correct, feedback_incorrect)
    VALUES
      (
        '22222222-2222-2222-2222-222222222222',
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM quest_steps WHERE quest_id = '33333333-3333-3333-3333-333333333333' AND step_number = 1) THEN
    INSERT INTO quest_steps (quest_id, step_number, title, instruction, step_type, options, correct_answer, feedback_correct, feedback_incorrect)
    VALUES
      (
        '33333333-3333-3333-3333-333333333333',
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM quest_steps WHERE quest_id = '44444444-4444-4444-4444-444444444444' AND step_number = 1) THEN
    INSERT INTO quest_steps (quest_id, step_number, title, instruction, step_type, options, correct_answer, feedback_correct, feedback_incorrect)
    VALUES
      (
        '44444444-4444-4444-4444-444444444444',
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM quest_steps WHERE quest_id = '55555555-5555-5555-5555-555555555555' AND step_number = 1) THEN
    INSERT INTO quest_steps (quest_id, step_number, title, instruction, step_type, options, correct_answer, feedback_correct, feedback_incorrect)
    VALUES
      (
        '55555555-5555-5555-5555-555555555555',
